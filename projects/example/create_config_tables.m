...
descriptions_init_cond = {
    ...
    'Data clipping size'
    'Arrange GPU device number (None for skipping)'
...
file_init_cond = 'config_init_cond.txt';
...
% Call the parsing function and create the table
file_iteration = 'config_iteration.txt';
...
%% ======================= 4. Save Tables        ==========================
save('config_tables.mat','config_init_cond_table','config_probe_table','config_iteration_table');
